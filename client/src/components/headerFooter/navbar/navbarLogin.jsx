      ...
      <div className="navbar">
        <ul className="navbar_ul">
          <li 
            ...
            onClick={() => {navigate("../"); setHeaderNav("abcd");}}
        ...
        <ul className="navbar_ul">
          <li className="navbar_list">
            ...
            {!account.is_admin && <div className={"navbar_a right_nav " + (disableCart && "disable_cart")}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            >
              <svg
                ...
                color="black"
                onClick={() => {account.is_admin? navigate("../admin") :navigate("../user"); setHeaderNav("");}}
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
