          ...
          <div className="cart_item_list">
            <div className="history_detail_item-info">
              ...
              <div className="history_detail_item_name-cat">
                <p className="history_detail_item-name">
                  Chaise Sectional Sofa
                </p>
                <p className="history_detail_item-cat">Pearl Spring</p>
                <p className="history_detail_item-cat history_detail_item-price">
                  $123
                </p>
              </div>
              <p className="history_detail_amount">
