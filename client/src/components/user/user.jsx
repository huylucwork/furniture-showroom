...
export default function User() {
    ...
    const [tabHistory, setTabHistory] = useState(false);
            ...
            <div className="history_sidebar">
                <div className="history_sidebar_container">
                    <button 
                        ...
                        type="button" 
                        onClick={() => { setTabInfo(true); setTabHistory(false)}}>
                        Profile
                    </button>
                ...
                <div className="history_sidebar_container">
                    <button 
                        className="history_user_sidebar-btn history_user-history history_sidebar_focus"
                        type="button" 
                        onClick={() => { setTabHistory(true); setTabInfo(false)}}>
                        History
                    </button>
